        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data:
                    ...
                    result_data.append({"Entity Number": entity, "Company Name": "Not Found", "Address": "", "Status": "", "Type": "", "Place of Business": "", "Eircode": ""})
            else:
                result_data.append({"Entity Number": entity, "Company Name": f"Error: {response.status_code}", "Address": "", "Status": "", "Type": "", "Place of Business": "", "Eircode": ""})
        except Exception as e:
            result_data.append({"Entity Number": entity, "Company Name": f"Exception: {e}", "Address": "", "Status": "", "Type": "", "Place of Business": "", "Eircode": ""})
